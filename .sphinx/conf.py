...
nitpick_ignore = [
    ('cpp:identifier', 'quantities'),
    ('cpp:identifier', 'interior'),
    ('cpp:identifier', 'axis'),
    ('cpp:identifier', 'domain')
]
nitpick_ignore_regex = [ (r'cpp:identifier', r'flecsi.*') ]
...
html_theme_options = {
    'canonical_url': 'http://www.flecsi.org/',
    'analytics_id': '',
    'logo_only': True,
...
html_logo = '_static/flecsi-sp.png'
...
latex_documents = [
    (master_doc, 'FleCSI-SP.tex', 'FleCSI-SP Documentation',
     'FleCSI-SP Team', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'FleCSI-SP', 'FleCSI-SP Documentation',
     author, 'FleCSI-SP', 'One line description of project.',
     'Miscellaneous'),
]
